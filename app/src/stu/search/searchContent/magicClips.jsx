...
export default function MagicClips({ searchedItem, setSearchCardVisible }) {
    const navigate = useNavigate();
    const [allMagicClips, setAllMagicClips] = useState([]);
    const [displayMagicClips, setDisplayMagicClips] = useState([]);
