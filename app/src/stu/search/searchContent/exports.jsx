...
export default function Exports({ searchedItem, setSearchCardVisible }) {
    const navigate = useNavigate()
    const [allMagicExports, setAllMagicExports] = useState([]);
    const [displayMagicExports, setDisplayMagicExports] = useState([]);
