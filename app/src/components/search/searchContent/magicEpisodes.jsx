...
export default function MagicEpisodes({ searchedItem, setSearchCardVisible }) {
    const navigate = useNavigate();
    const [allMagicEpisodes, setAllMagicEpisodes] = useState([]);
    const [displayMagicEpisodes, setDisplayMagicEpisodes] = useState([]);
